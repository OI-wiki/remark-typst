...
`
  ...
  function parse(node) {
    ...
    switch (node.type) {
      ...
      case 'text': {
        // TODO: remove spaces between text objects?
...
hlinex(),
      ...
      case 'math': { // 行间公式
        ...
        if (texmath.status === 1) {
          const err = texmath.stderr.toString('utf8')
          console.log('[WARNING] Problem converting display math. Falling back to SVG:\n' + err)
